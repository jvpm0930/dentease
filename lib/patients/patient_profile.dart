  ...
  Future<void> _fetchPatientDetails() async {
    try {
      final response = await supabase
          .from('patients')
          .select(
              'firstname, lastname, email, phone, role, profile_url, gender, age, password, fcm_token')
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildInfoTile(Icons.person_rounded, "First Name",
                            patientDetails?['firstname'] ?? ''),
                        _buildInfoTile(Icons.person_outline_rounded,
                            "Last Name", patientDetails?['lastname'] ?? ''),
                        _buildInfoTile(Icons.cake_rounded, "Age",
